...
public class detail03 {
	...
	public void start()  {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/detail/fxmlPages/detail03.fxml"));
		Parent root=null;
		try {
			root = loader.load();
		} catch (IOException e) {
		...
		DetailController03 ctl = loader.getController();
		ctl.setRoot(root);
		primaryStage.setScene(scene);
		primaryStage.show();
		///////////////////////////////////////////
		MovieDTO dto = db.selectSQL("기적");
		DetailController03 dc = loader.getController();
		dc.setRoot(root);
