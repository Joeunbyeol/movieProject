...
import db.dbService;
import detail.Controller.DetailController05;
...
public class detail05{
	...
	public void start()  {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/detail/fxmlPages/detail05.fxml"));
		Parent root=null;
		try {
			root = loader.load();
		} catch (IOException e) {
		...
		DetailController05 ctl = loader.getController();
		ctl.setRoot(root);
		primaryStage.setScene(scene);
		primaryStage.show();
		///////////////////////////////////////////
	
		DetailController05 dc = loader.getController();
		dc.setRoot(root);
