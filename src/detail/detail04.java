...
public class detail04 {
	...
	public void start()  {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/detail/fxmlPages/detail04.fxml"));
		Parent root=null;
		try {
			root = loader.load();
		} catch (IOException e) {
		...
		DetailController04 ctl = loader.getController();
		ctl.setRoot(root);
		primaryStage.setScene(scene);
		primaryStage.show();
		///////////////////////////////////////////
		MovieDTO dto = db.selectSQL("샹치와 텐 링즈의 전설");
		DetailController04 dc = loader.getController();
		dc.setRoot(root);
